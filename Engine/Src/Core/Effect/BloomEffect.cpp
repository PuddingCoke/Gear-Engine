...
UniquePtr<Gear::Core::Effect::BloomEffect> Gear::Core::Effect::BloomEffect::create(GraphicsContext* const context, const uint32_t width, const uint32_t height, ResourceManager* const resManager)
{
...
Gear::Core::Resource::TextureRenderView* Gear::Core::Effect::BloomEffect::process(Resource::TextureRenderView& inputTexture)
{
