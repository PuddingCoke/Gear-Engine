...
static RWTexture2DArray<float2> depthOctahedralMap = ResourceDescriptorHeap[depthOctahedralMapTexIndex];

static TextureCube<float> depthCube = ResourceDescriptorHeap[depthCubeTexIndex];
